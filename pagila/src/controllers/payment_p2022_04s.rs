...
use crate::models::_entities::payment_p2022_04s::{ActiveModel, Entity as PaymentP202204s, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(PaymentP202204s::find().all(&ctx.db).await?)
}
