...
use crate::models::_entities::payment_p2022_03s::{ActiveModel, Entity as PaymentP202203s, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(PaymentP202203s::find().all(&ctx.db).await?)
}
