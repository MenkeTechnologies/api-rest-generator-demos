...
use crate::models::_entities::payment_p2022_01s::{ActiveModel, Entity as PaymentP202201s, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(PaymentP202201s::find().all(&ctx.db).await?)
}
