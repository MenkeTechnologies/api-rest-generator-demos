...
use crate::models::_entities::payment_p2022_06s::{ActiveModel, Entity as PaymentP202206s, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(PaymentP202206s::find().all(&ctx.db).await?)
}
