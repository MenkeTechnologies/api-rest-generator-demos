...
use crate::models::_entities::payment_p2022_05s::{ActiveModel, Entity as PaymentP202205s, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(PaymentP202205s::find().all(&ctx.db).await?)
}
