...
use crate::models::_entities::film_actors::{ActiveModel, Entity as FilmActors, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(FilmActors::find().all(&ctx.db).await?)
}
