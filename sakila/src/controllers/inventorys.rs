...
use crate::models::_entities::inventorys::{ActiveModel, Entity as Inventorys, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(Inventorys::find().all(&ctx.db).await?)
}
