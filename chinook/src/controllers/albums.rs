...
use crate::models::_entities::albums::{ActiveModel, Entity as Albums, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
        ...
        item.artist_id = sea_orm::ActiveValue::set(self.artist_id.clone());
    }
}
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(Albums::find().all(&ctx.db).await?)
}
...
pub async fn add(State(ctx): State<AppContext>, Json(params): Json<Params>) -> Result<Response> {
        let item = ActiveModel {
            ...
            artist_id: sea_orm::ActiveValue::set(params.artist_id.clone()),
            ..Default::default()
        };
