...
use crate::models::_entities::media_types::{ActiveModel, Entity as MediaTypes, Model};
...
pub async fn list(State(ctx): State<AppContext>) -> Result<Response> {
    format::json(MediaTypes::find().all(&ctx.db).await?)
}
